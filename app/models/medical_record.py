...
This schema represents medical records uploaded to the system, linking patient information with secure document storage, blockchain verification, and metadata.
...
class MedicalRecord(db.Document):
    ...
    description = db.StringField(
        required=False,
        help_text="Brief description or notes about the medical record."
    )
    ...
    meta = {
        'indexes': [
            {
                'fields': ['patient_id'],
                'name': 'patient_medical_records_idx'
            },
            {
    ...
    def clean(self):
        ...
        Ensures the file_url field follows encryption guidelines (placeholder for actual encryption checks).
        """
